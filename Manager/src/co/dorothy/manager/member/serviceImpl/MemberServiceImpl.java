package co.dorothy.manager.member.serviceImpl;
...
public class MemberServiceImpl implements MemberService {
	...
	private PreparedStatement psmt; 				//conn 통해서 sql과 명령을 전달하고 실행하는 객체
	private ResultSet rs;							// select 구문 호출시 결과 돌려받는 객체
